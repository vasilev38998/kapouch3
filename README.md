...
- Интерфейс PWA дополнительно русифицирован: навигация, статусы персонала и элементы админки переведены на русский для единого UX.
- Главный экран переработан: динамическая «подсказка дня», улучшенный hero и информативные KPI-блоки.
