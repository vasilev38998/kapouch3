<h2>Уведомления в профиль</h2>
<section class="card fade-in">
  <div class="muted">Рассылка идёт только во внутреннюю ленту пользователя (без браузерных push).</div>
...
<form method="post" class="card fade-in">
  ...
  <label>Картинка (URL, опционально)</label><input id="pushUrl" name="url" placeholder="https://...">
  ...
  <button class="btn">Отправить уведомление</button>
</form>
...
<form method="post" class="card fade-in">
  ...
  <label>Картинка (URL)</label><input name="template_url">
